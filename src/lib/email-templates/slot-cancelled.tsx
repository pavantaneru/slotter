...
export function SlotCancelledEmail({attendeeName, pageName, slotStart, slotEnd, pageSlug, appUrl}: SlotCancelledEmailProps) {
		...
		<Html>
			...
			<Body style={main}>
				<Container style={container}>
					...
					<Hr style={divider} />
					<Text style={footer}>We apologize for any inconvenience.</Text>
				</Container>
			</Body>
		</Html>
	);
